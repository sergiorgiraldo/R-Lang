...
pbp2011 <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\all2011.csv")
headers <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\fields.csv")
...
pbp11rc <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\pbp11rc.csv")
