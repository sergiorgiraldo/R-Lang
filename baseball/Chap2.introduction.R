...
spahn <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\spahn.csv")
...
NLbatting <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\NLbatting.csv")
ALbatting <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\ALbatting.csv")
batting <- rbind(NLbatting, ALbatting)

NLpitching <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\NLpitching.csv")
...
Batting <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\Batting.csv")
