...
fg <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\FanGraphs Leaderboard.csv")
names(fg)[1] <- "Name"
head(fg)
...
teamD <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\teamD.csv")
...
jetrol <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\jeter_rollins.csv")
head(jetrol)
