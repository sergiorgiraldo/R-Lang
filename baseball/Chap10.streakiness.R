...
joe <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\dimaggio.1941.csv")
...
data2011 <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\all2011.csv", header=FALSE)
fields <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\fields.csv")
...
roster2011 <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\roster2011.csv")
