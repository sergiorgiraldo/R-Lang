...
hof <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\hofbatting.csv")
...
data1998 <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\all1998.csv", header=FALSE)
fields <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\fields.csv")
names(data1998) <- fields[, "Header"]

retro.ids <- read.csv("C:\\Users\\sgiraldo\\source\\R\\baseball\\data\\retrosheetIDs.csv")
